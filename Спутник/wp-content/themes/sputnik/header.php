<?php
$eng_buttom = get_field('eng_buttom','option');
?>
<!doctype html>
<html <?php language_attributes(); ?>>

<head>
    <link rel="stylesheet" href="/wp-content/themes/sputnik/styleFelix.css?ver=1.1">
        ...
        <header class="header">
            <div class="container header__container row">
				...
				?>
             	...
             	<a href="<?=$eng_buttom?>" target="_blank" class = "header__eng">Eng 
             </a>
