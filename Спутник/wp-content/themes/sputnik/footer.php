...
<div class="footer">
    <div class="container-bordering"> <a class="footer--publisher" href="https://sk.ru/" target="_blank">
            <div class="skolk-div"> </div>
        </a>
        <div class="footer--navigation"> <a class="navigation-link" href="#"> </a>
            <a class="navigation-link" href="<?=$social_tg?>" target="_blank" id="tg-logo">
            ...
            <a class="navigation-link" href="<?=$social_yt?>" target="_blank" id="yt-logo">
            ...
            <a class="navigation-link" href="<?=$social_vk?>" target="_blank" id="vk-logo">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="navigation-link" href="<?=$social_li?>" target="_blank" id="linkedin-logo">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
